...
Mock.mock(/\/dist\/getDistList/, 'get', getDistList)
Mock.mock(/\/role\/getRoleLine/, 'get', getRoleLine)
Mock.mock(/\/role\/getRole/, 'get', getRole)
Mock.mock(/\/role/, 'get', role)
Mock.mock(/\/permission\/getUserData/, 'get', permissionUserData)
Mock.mock(/\/permission\/no-pager/, 'get', permissionNoPager)
Mock.mock(/\/permission/, 'get', permissions)
Mock.mock(/\/menu\/getMenuDesign/, 'get', getMenuDesign)
