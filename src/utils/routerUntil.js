...
const constantRouterComponents = {
  ...
  PerfessionWrapSecond: () => import('@/views/auditManage/estateAudit/PerfessionWrapSecond'),
  PerfessionSecond_Edit: () => import('@/views/auditManage/estateAudit/PerfessionSecond_Edit'),
  ...
  RedReverse: () => import('@/views/auditManage/auditWrap/RedReverse'), // TODO 红冲销量
  RedReverse_Edit: () => import('@/views/auditManage/auditWrap/RedReverse_Edit'),
  EstateRedReverse: () => import('@/views/auditManage/auditWrap/EstateRedReverse'),
  // 异常提醒
