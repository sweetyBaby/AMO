<template>
  <a-card :bordered="false" v-if="pageIndex">
    ...
    <div class="scanEmpty" v-else>
      ...
      <div class="scanInfo">
        ...
        <div class="scanList" @click="scanUpload">
          <span class="scanIcon">
        ...
        <div class="scanBor"></div>
        <div class="scanList" @click="manualUpload">
          <span class="scanIcon">
            <i class="iconfont icon-plus" ></i>
          </span>
          <div class="scanMain">
  ...
  <a-card :bordered="false" v-else-if="pageDetails">
    <add-details @details="scanBack" :detailsDataProp="detailsData"></add-details>
...
export default {
  ...
  methods: {
    ...
    handleDetails (text, record) {
      // 添加明细
      // console.log(record);
      this.detailsData.invoiceId = record.id
