  ...
  <div :bordered="false">
    ...
    <a-form layout="inline">
      <div class="basicBorder">
        <a-row :gutter="24">
          <a-col span="8">
            <label for="" class="basicTitle">出库单号</label>
            <div class="basicInfo">
              {{ titleData.docNo }}
            </div>
          </a-col>
          <a-col span="8">
            <label for="" class="basicTitle">经销商/配送商名称</label>
            <div class="basicInfo">
              {{ titleData.distName }}
            </div>
          </a-col>
    ...
    <div class="imgList">
      ...
      <div class="imgContainer">
        <div class="imgshow" v-for="(item,key) in imgList" :key="key">
          <img :src="item.fileUrl" alt="">
          <div class="mask"><i class="iconfont icon-enlarge" @click="imgShow(item.fileUrl)"></i></div>
        </div>
      </div>
      <a-modal :visible="imgVisible" :footer="null" @cancel="handleCancel" width="660px" class="imgModal">
...
<script>
import { outVoucherDetails } from '@/api/auditManage/outVoucher'
