  ...
  <a-form layout="inline" :form="form">
    <div class="invoiceTableManual">
      <a-row :gutter="24">
          ...
          <a-row class="tablecell">
            ...
            <a-col :span="18" class="rightcell">
              <a-date-picker
                ...
                :disabled="titleData.reportType==='1' ? true : titleData.verifyStatus === '03' ? true : false"
        ...
        <a-col :span="8" :style="{padding: '6px 0 0 0',height: '124px',}">
          <a-row class="tablecell">
            <a-col :span="6" class="leftcell" :style="{height: '116px'}">
              备注
            </a-col>
            <a-col :span="18" class="rightcell" :style="{height: '116px'}">
              <a-input
        ...
        <!--        </a-col>-->
        <a-col :span="16" :style="{padding: '6px 0 0 0',height: '124px',}">
          <a-row class="tablecell">
            <a-col :span="3" class="leftcell" :style="{height: '112px'}"><span class="mustFill">*</span>单据凭证</a-col>
            <a-col :span="21" class="rightcell" :style="{height: '112px'}">
              <a-upload
      ...
      if (this.isSubmit) {
        ...
        if (
          this.isDataEmpty(currentData.docNo) ||
            this.isDataEmpty(currentData.docDate) ||
