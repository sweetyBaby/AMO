<template>
  ...
  <a-card :bordered="false" v-else-if="pageManual">
    <ManualInput @manualInput="scanBack"></ManualInput>
  </a-card>
  <a-card :bordered="false" v-else-if="pageImg">
    <ImgRecog @imgRecog="scanBack" @imgRecogClear="imgRecogClear" :imgUploadList="imgUploadList"></ImgRecog>
  </a-card>
...
import { DataFilter, exportTable, BtnShow } from '@/utils/storage'
