...
import { getWareList, userDistRange, zeroList, salesReport } from '@/api/depot/wareHouse'
export default {
  name: 'MonthReport',
  components: {
    DhEmpty,
  ...
  data () {
    return {
      ...
      loadData: parameter => {
        return salesReport(Object.assign(this.queryParam, parameter)).then(res => {
          const saleReport = DataFilter(res, 'saleReport')
          this.tableList = saleReport
