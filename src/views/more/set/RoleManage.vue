        ...
        <template>
          <a-popover placement="bottomRight" overlayClassName="tableBtn">
            <template slot="title">
              ...
              <a href="javascript:;" @click="showDeleteConfirm(record)">
...
export default {
  ...
  data() {
    return {
      ...
      loadData: parameter => {
        return getRoleNewList(Object.assign(this.queryParam, parameter)).then(
          res => {
            console.info(res)
  ...
  methods: {
    ...
    handleAdd(val) {
      ...
      const callback = function() {
        _that.isNewRole = false
        console.log('销毁')
        window.removeEventListener('popstate', callback)
      }
      history.pushState(null, null, '/more/set/RoleManage#detail')
